...
import io.appium.java_client.service.local.AppiumDriverLocalService;
	...
	public static void startEmulator() throws IOException, InterruptedException {
		Runtime.getRuntime().exec(System.getProperty("user.dir")+"\\src\\main\\java\\Exp\\resources\\emulator.bat");
		Thread.sleep(10000);
	}
	...
	public static  AndroidDriver<AndroidElement> capabilities(String AppName) throws IOException, InterruptedException
	{
		...
		FileInputStream fis=new FileInputStream(System.getProperty("user.dir")+"\\src\\main\\java\\Exp\\MAF2\\global.properties");
